...
import 'package:webview_flutter/webview_flutter.dart';
import 'package:webview_flutter_web/webview_flutter_web.dart'; // for Web
...
void main() async {
  ...
  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    home: GoogleMapEmbedPage(), // or your main page
  ));
}
...
class GoogleMapEmbedPage extends StatefulWidget {
  @override
  _GoogleMapEmbedPageState createState() => _GoogleMapEmbedPageState();
}
